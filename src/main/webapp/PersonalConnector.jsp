...
<title>xdi2-connector-personal</title>
...
<body style="background-image: url('images/back.png'); background-repeat: repeat-y; margin-left: 60px;">
	...
	<p class="subheader">Obtain Personal API Access Token</p>

	<p>This step will initiate an OAuth "code flow" (also known as "server-side flow") to the Personal API, in order to obtain an access token.</p>
	<p>The token is then stored in your XDI graph, where it is picked up and used by the XDI2 server to handle requests to your Personal XDI context.</p>
	...
	<p>Certain parts of your graph will only be accessible if you have a Personal API access token.</p>
